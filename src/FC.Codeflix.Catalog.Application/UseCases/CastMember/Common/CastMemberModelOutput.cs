...
public class CastMemberModelOutput
{
    ...
    public static CastMemberModelOutput FromCastMember(Domain.Entity.CastMember castMember) => new(
            castMember.Id, castMember.Name, castMember.Type, castMember.CreatedAt);
}
